...
### Master Layout Template Structure (folderType: 7)
```razor
<!DOCTYPE html>
<html lang="en">
<head>
...
### Page Template Structure (folderType: 1)
```razor
@{
...
<!-- Hero Section -->
<div class="page-header header-filter clear-filter {color}-filter" data-parallax="true" style="background-image: url('../assets/img/{bg-image}.jpg');">
    <div class="container">
        <div class="row">
...
2. **Create Page Template** using `CreateTemplate`:
...
3. **Create page content** using `CreatePageContent`:
