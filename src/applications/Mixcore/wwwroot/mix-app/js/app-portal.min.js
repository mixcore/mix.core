/* Mon Dec 13 2021 00:03:20 GMT+0700 (Indochina Time) */"use strict";
...
app.controller("ModuleController", [
  ...
  function (
    ...
    $scope.saveSuccessCallback = async function () {
      await $scope.saveAdditionalData();
    };
    $scope.saveAdditionalData = async () => {
      if ($scope.additionalData) {
        ...
        if (!result.success) {
          ...
          $scope.additionalData.id = result.data;
          $scope.saveColumns();
        }
      }
    };
    ...
    $scope.saveAdditionalData = async () => {
      if ($scope.additionalData) {
        ...
        if (!result.success) {
          ...
          $scope.additionalData.id = result.data.id;
          $scope.saveColumns();
        }
      }
    };
