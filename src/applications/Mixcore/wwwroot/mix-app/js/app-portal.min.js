/* Fri Dec 09 2022 01:10:10 GMT+0700 (Indochina Time) */"use strict";
...
app.component("mixMetadata", {
  ...
  controller: [
    ...
    function (
      ...
      ctrl.$onInit = async () => {
        ctrl.request = angular.copy(ngAppSettings.request);
        ctrl.request.contentType = ctrl.parentType;
        ctrl.request.contentId = ctrl.parentId;
      ...
      ctrl.addMetadata = async () => {
        if (ctrl.keyword) {
          var tmp = ctrl.data.items.find((m) => m.content == ctrl.keyword);
          if (!tmp) {
