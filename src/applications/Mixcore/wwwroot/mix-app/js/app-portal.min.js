/* Sat Nov 27 2021 08:44:22 GMT+0700 (Indochina Time) */"use strict";
...
app.component("themeExportPosts", {
  ...
  controller: [
    ...
    function ($rootScope, $scope, ngAppSettings, service) {
      ...
      ctrl.updateContent = function (arr, selected) {
        if (selected) {
          ctrl.exportThemeDto.content.postIds = ctrl.unionArray(
            ctrl.exportThemeDto.content.postIds,
            arr
          );
        } else {
          ctrl.exportThemeDto.content.postIds =
            ctrl.exportThemeDto.content.postIds.filter(
              (m) => arr.indexOf(m) < 0
            );
          ctrl.updateData(arr, false);
        }
      ...
      ctrl.updateData = function (arr, selected) {
        if (selected) {
          ctrl.exportThemeDto.data.postIds = ctrl.unionArray(
            ctrl.exportThemeDto.data.postIds,
            arr
          );
        } else {
          ctrl.exportThemeDto.data.postIds =
            ctrl.exportThemeDto.data.postIds.filter((m) => arr.indexOf(m) < 0);
        }
      };
      ctrl.selectAll = function (arr) {
        // ctrl.selectedList.data = [];
