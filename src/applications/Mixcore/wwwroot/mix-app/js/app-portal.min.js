/* Thu Sep 15 2022 10:23:40 GMT+0700 (Indochina Time) */"use strict";
  ...
  function (
    ...
    $scope.initList = async function () {
      $scope.request.queries.push(
        $scope.parseQueryField("mixcoreVersion", "2.0.1")
      );
      if ($routeParams.template) {
    ...
    $scope.loadPostTypes = async function () {
      ...
      if (getTypes.success) {
        $scope.postTypes = getTypes.data.items;
    ...
    $scope.onSelectType = function () {
      if ($scope.viewmodel) {
        $scope.viewmodel.mixDatabaseName = $scope.postType.systemName;
        mixDbService.initDbName($scope.viewmodel.mixDatabaseName);
        $scope.loadAdditionalData();
      }
