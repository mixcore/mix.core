/* Sat May 13 2023 15:33:51 GMT+0700 (Indochina Time) */"use strict";
  ...
  function (
    ...
    $scope.getSingleSuccessCallback = async function () {
      if ($routeParams.couponId) {
        ...
        $scope.viewmodel.isSendEmail = false;
        $scope.viewmodel.isSendNotification = false;
      }
    };
  },
]);
...
app.controller("FloralpunkCouponController", [
  ...
  function (
    ...
    // write code to parse date to iso string with an date input
...
app.factory("FloralpunkCouponService", [
  ...
  function (baseService) {
    ...
    serviceFactory.initService("/rest", "floralpunk/coupon", true, "", "", "");
...
"use strict";
app.controller("KiotvietInvoiceController", [
  "$scope",
  "$rootScope",
  "ngAppSettings",
  "$routeParams",
...
"use strict";
app.factory("KiotvietInvoiceService", [
  "BaseRestService",
  function (baseService) {
    var serviceFactory = Object.create(baseService);
    serviceFactory.buildRequestUrl = function (req) {
    ...
    serviceFactory.initService("/rest", "floralpunk/invoice", true, "", "", "");
    serviceFactory.prefixUrl = `/api/floralpunk/invoice`;
    serviceFactory.customBaseUrl = true;
    return serviceFactory;
  },
]);
...
app.controller("FloralpunkMembershipController", [
  ...
  function (
    ...
    $scope.syncUser = async function (phoneNumber) {
      $rootScope.isBusy = true;
      var result = await service.syncUser(phoneNumber);
      if (result.success) {
        $rootScope.showMessage("Success", "success");
      } else {
        $rootScope.showErrors(result.errors);
...
app.factory("FloralpunkMembershipService", [
  ...
  function (baseService, apiService) {
    ...
    serviceFactory.customBaseUrl = true;
    var _syncUser = async function (phoneNumber) {
      var req = {
        apiVersion: "",
        serviceBase: "",
        method: "GET",
        url: `/api/floralpunk/membership/sync-user/${phoneNumber}`,
      };
      return this.getRestApiResult(req);
    };
    serviceFactory.syncUser = _syncUser;
    return serviceFactory;
  },
]);
