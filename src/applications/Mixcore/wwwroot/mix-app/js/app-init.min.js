  ...
  function ($scope, $rootScope, commonService, step1Services) {
    ...
    $scope.settings = {
      providers: [
        ...
        },
        {
          ...
          value: "SQLSERVER",
          port: null,
          img: "/mix-app/assets/img/SQLSERVER.jpg",
        },
        {
    ...
    $scope.initCmsModel = {
      ...
      localDbConnectionString:
        "Server=(localdb)\\SQLSERVERLocalDB;Initial Catalog=" +
        rand +
    ...
    $scope.updateLocalDbName = function () {
      ...
      $scope.initCmsModel.localDbConnectionString =
        "Server=(localdb)\\SQLSERVERlocaldb;Database=" +
...
modules.component("SQLSERVERInfo", {
  templateUrl:
    "/mix-app/views/app-init/pages/step1/components/SQLSERVER-info/view.html",
  controller: [
    "$rootScope",
    function ($rootScope) {
      var ctrl = this;
...
modules.component("SQLSERVERLocalInfo", {
  templateUrl:
    "/mix-app/views/app-init/pages/step1/components/SQLSERVER-local-info/view.html",
  controller: [
    "$rootScope",
    function ($rootScope) {
      var ctrl = this;
