/* Thu Feb 13 2025 10:29:46 GMT+0700 (Indochina Time) */"use strict";
...
app.controller("DashboardController", [
  ...
  function (
    ...
    $scope.joinStore = function (storeId) {
      $scope.connection
        .invoke("JoinRoom", `one-ticket-${storeId}`)
        .then((result) => {
          console.log(result);
    ...
    $scope.leaveRoom = function (storeId) {
      $scope.connection
        .invoke("LeaveRoom", `one-ticket-${storeId}`)
        .then((result) => {
          console.log(result);
          $scope.storeId = storeId;
        })
    ...
    $scope.sendMessage = function (content) {
      $scope.connection
        .invoke("SendMessageToPublic", content)
        .then((result) => {
          console.log(result);
          $scope.storeId = storeId;
        })
    ...
    $scope.sendGroupMessage = function (content) {
      $scope.connection
        .invoke("SendMessageToPublic", content, `one-ticket-${storeId}`)
        .then((result) => {
          console.log(result);
          $scope.storeId = storeId;
        })
    ...
    $scope.sendPrivateMessage = function (content, connectionId) {
      $scope.connection
        .invoke("SendMessageToConnection", content, connectionId)
        .then((result) => {
          console.log(result);
          $scope.storeId = storeId;
        })
        ...
        ctrl.fieldNames = {
          ...
          lastModified:
            ctrl.namingConvention == "TitleCase"
              ...
              : "last_modified",
          tenantId:
            ctrl.namingConvention == "TitleCase" ? "TenantId" : "tenant_id",
          createdBy:
