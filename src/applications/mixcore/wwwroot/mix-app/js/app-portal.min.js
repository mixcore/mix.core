/* Sun Jun 01 2025 15:38:08 GMT+0700 (Indochina Time) */"use strict";
...
app.controller("DashboardController", [
  ...
  function (
    ...
    var endpoints = JSON.parse(localStorage.getItem("ls.endpoints") || "{}");
    BaseHub.call(this, $scope, endpoints.OneApp);
...
app.controller("MixDbDataController", [
  ...
  function (
    ...
    $scope.initRouteParams = async () => {
      ...
      $scope.dataUrl = `/admin/mix-db-table-data/list?mixDatabaseId=${$scope.mixDatabaseId}&mixDbTableName=${$scope.mixDbTableName}&mixDatabaseTitle=${$scope.mixDatabaseTitle}`;
    ...
    $scope.saveSuccess = function (data) {
      if ($scope.backUrl) {
        ...
        $location.url(
          `/admin/mix-db-table-data/details?dataContentId=${data}&mixDatabaseTitle=${
    ...
    $scope.edit = function (data) {
      $rootScope.goToPath(
        `/admin/mix-db-table-data/details?dataContentId=${data.id}&mixDbTableName=${$scope.mixDbTableName}&mixDatabaseTitle=${$scope.mixDatabaseTitle}`
      );
    };
...
app.controller("MixDatabaseController", [
  ...
  function (
    ...
    $scope.initList = async function () {
      $scope.request.mixDatabaseContextId = $routeParams.mixDatabaseContextId;
      await $scope.getList();
    };
    ...
    $scope.getSingleSuccessCallback = async function () {
      if (!$scope.viewmodel.mixDatabaseContextId) {
        $scope.viewmodel.mixDatabaseContextId =
          $routeParams.mixDatabaseContextId;
      }
...
app.controller("RoleController", [
  ...
  function (
    ...
    $scope.initPermissions = async function () {
      ...
      $scope.createUrl = `/admin/mix-db-table-data/create?mixDbTableName=sysPermission&dataContentId=&parentId=${$scope.viewmodel.id}&parentName=Role&backUrl=${backUrl}`;
      $scope.updateUrl = "/admin/mix-db-table-data/details";
    };
...
app.controller("ServiceController", [
  ...
  function (
    ...
    $scope.saveSuccessCallback = function () {
      ...
      $scope.$apply();
      // if($scope.parentId){
      //     $location.url('/admin/mix-db-table-data/details?dataContentId='+ $scope.parentId);
      // }
      // else{
      //     $location.url('/admin/mix-db-table-data/list?mixDatabaseId='+ $scope.viewmodel.mixDatabaseId);
      // }
    };
    $scope.getList = async function () {
      $rootScope.isBusy = true;
    ...
    $scope.edit = function (data) {
      $scope.goToPath(
        "/admin/mix-db-table-data/details?dataContentId=" +
          data.id +
          "&mixDatabaseId=" +
          $scope.mixDatabaseId
      );
...
app.component("mixdbContextDatabases", {
  ...
  templateUrl:
    "/mix-app/views/app-portal/pages/mixdb-context/components/mix-db-tables/view.html",
  controller: [
    "$rootScope",
    "$scope",
    "RestMixDbTablePortalService",
...
app.component("themeImportMixDatabases", {
  ...
  controller: [
    ...
    function ($rootScope, $scope, ngAppSettings) {
      ...
      ctrl.request = angular.copy(ngAppSettings.request);
      ctrl.$onInit = async () => {
        ctrl.data = ctrl.importData.mixDatabases;
      };
      ...
      ctrl.selectContent = (mixDatabase, selected) => {
        ...
        ctrl.importThemeDto.mixDatabaseIds = ctrl.updateArray(
          ctrl.importThemeDto.mixDatabaseIds,
          [mixDatabase.id],
          selected
        );
        if (!selected) {
...
modules.component("listMixColumn", {
  ...
  controller: [
    ...
    function (
      ...
      ctrl.$onInit = async function () {
        ctrl.dataTypes = $rootScope.globalSettings.dataTypes;
        ctrl.request.mixDatabaseContextId = ctrl.mixDatabaseContextId;
...
modules.component("mixDbDataFilter", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-data-filter/view.html",
  bindings: {
    query: "=",
    mixDbTableName: "=?",
    mixDatabaseId: "=?",
...
modules.component("mixDbDataValues", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-data-values/view.html",
  bindings: {
    database: "=?",
    request: "=",
    mixDbTableName: "=?",
  ...
  controller: [
    ...
    function (
      ...
      ctrl.$onInit = async function () {
        ...
        ctrl.createUrl = `/admin/mix-db-table-data/create?mixDatabaseId=${
          ctrl.database.id
      ...
      ctrl.update = function (data) {
        let url = `/admin/mix-db-table-data/details?dataContentId=${
          data.id
        }&mixDbTableName=${ctrl.request.mixDbTableName}&mixDatabaseTitle=${
      ...
      ctrl.view = function (item) {
        ...
        $rootScope.preview("mix-db-table-data", obj, null, "modal-lg");
      };
    },
  ],
});
...
modules.component("mixDatabaseForm", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-form/view.html",
  bindings: {
    database: "=?",
    mixDatabaseId: "=?",
    mixDbTableName: "=?",
    ...
    function (
      ...
      ctrl.loadData = async function () {
        ...
        */
        ...
        if (
          !ctrl.mixDataContent &&
          (ctrl.mixDbTableName || ctrl.mixDatabaseId) &&
          !ctrl.defaultData
        ) {
          ctrl.mixDataContent = {};
          if (ctrl.parentId) {
      ...
      ctrl.loadExistingData = async function () {
        ...
        if (ctrl.mixDataContent) {
          ...
          ctrl.backUrl =
            ctrl.backUrl ??
            `/admin/mix-db-table-data/list?mixDatabaseId=${ctrl.mixDataContent.mixDatabaseId}&mixDbTableName=${ctrl.mixDbTableName}&mixDatabaseTitle=${ctrl.mixDatabaseTitle}`;
          // await ctrl.loadDefaultModel();
          ctrl.isBusy = false;
        } else {
          if (getData) {
...
modules.component("mixDbDataValueEditor", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-data-value-editor/view.html",
  bindings: {
    mixDbDataValue: "=?",
    parentType: "=?",
    parentId: "=?",
  ...
  controller: [
    ...
    function (
      ...
      ctrl.updateRefData = function (nav) {
        ctrl.goToPath(`/admin/mix-db-table-data/details?dataContentId=${nav.data.id}
        ...
        // $location.url('/admin/mix-db-table-data/details?dataContentId='+ item.id +'&mixDatabaseId=' + item.mixDatabaseId+'&parentType=' + item.parentType+'&parentId=' + item.parentId);
      };
...
modules.component("mixDatabaseNavValues", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-nav-values/view.html",
  bindings: {
    mixDatabaseId: "=",
    mixDbTableName: "=",
    guidParentId: "=",
  ...
  controller: [
    ...
    function ($rootScope, $scope, ngAppSettings, navService, columnService) {
      ...
      ctrl.$onInit = async function () {
        ...
        if (!ctrl.createUrl) {
          ctrl.createUrl = "/admin/mix-db-table-data/create";
        }
        if (!ctrl.updateUrl) {
          ctrl.updateUrl = "/admin/mix-db-table-data/details";
        }
        if (!ctrl.columns) {
...
modules.component("mixDatabaseNavData", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-nav-data/view.html",
  bindings: {
    nav: "=",
    parentId: "=",
    parentType: "=",
...
modules.component("mixDatabaseNestedDataValues", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-db-table-nested-data-values/view.html",
  bindings: {
    database: "=?",
    fieldNames: "=?",
    mixDbTableName: "=?",
  ...
  controller: [
    ...
    function (
      ...
      ctrl.loadHelperUrl = function () {
        ...
        if (
          portalUrl.startsWith("/admin/mix-db-table-data/list?mixDatabaseId=2")
        ) {
          ctrl.trustedUrl = $sce.trustAsResourceUrl(
        ...
        if (
          portalUrl.startsWith("/admin/mix-db-table-data/list?mixDatabaseId=7")
        ) {
          ctrl.trustedUrl = $sce.trustAsResourceUrl(
        ...
        if (
          portalUrl.startsWith("/admin/mix-db-table-data/list?mixDatabaseId=8")
        ) {
          ctrl.trustedUrl = $sce.trustAsResourceUrl(
