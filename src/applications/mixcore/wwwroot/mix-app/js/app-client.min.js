  ...
  app.controller("AppClientController", [
    ...
    function (
      ...
      $scope.init = function (lang) {
        ...
        mixDbDataService.init(mixDbDataService.modelName, false, lang);
        if (!$rootScope.isBusy) {
  ...
  controller: [
    ...
    function ($rootScope, $scope, columnService, service) {
      ...
      ctrl.updateDataType = function () {
        ctrl.mixDbData.data.data_type = ctrl.msgField.dataType;
      };
...
app.factory("RestNavigationService", [
  ...
  function (baseService, apiService, commonService) {
    ...
    serviceFactory.init("mix-db-table-data/navigation");
    var _initData = async function (mixDbTableName) {
      var url = this.prefixUrl + "/init/" + mixDbTableName;
      var req = {
        method: "GET",
        url: url,
      };
