    ...
    $rootScope.showErrors = function (errors) {
      if (errors.length) {
        angular.forEach(errors, function (e) {
          $rootScope.showMessage(e.message, "danger");
        });
      } else {
  ...
  controller: [
    ...
    function (
      ...
      ctrl.$onInit = async function () {
        ...
        if (ctrl.model) {
          if ($routeParams[ctrl.column.systemName]) {
            ctrl.model[ctrl.column.systemName] =
              $routeParams[ctrl.column.systemName];
          }
          if (
            ctrl.column.dataType == "Integer" &&
            ctrl.model[ctrl.column.systemName]
          ) {
  ...
  function (
    ...
    ctrl.ok = async function () {
      if (!ctrl.autoSave) {
        ...
        ctrl.media.mediaFile.fileBase64 = ctrl.cropped.image;
    ...
    ctrl.combineImage = function () {
      ...
      if (ctrl.canvas) {
        ...
        $scope.$apply(function () {
          ctrl.postedFile.fileBase64 = ctrl.canvas.toDataURL(); //ctx.getImageData(0, 0, 300, 350);
          ctrl.imgUrl = ctrl.postedFile.fileBase64.replace(
            "image/png",
            "image/octet-stream"
          );
        });
  ...
  controller: [
    ...
    function (
      ...
      ctrl.init = async function () {
        ...
        ctrl.themeRequest.sortBy = "createdDatetime";
      ...
      ctrl.gotDevices = function (deviceInfos) {
        for (let i = 0; i !== deviceInfos.length; ++i) {
          ...
          if (deviceInfo.kind === "audioinput") {
            option.text = "microphone " + (ctrl.audioSelect.length + 1);
            ctrl.audioSelect.appendChild(option);
          } else if (deviceInfo.kind === "videoinput") {
            option.text = "camera " + (ctrl.videoSelect.length + 1);
