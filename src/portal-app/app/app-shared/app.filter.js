...
app.filter('utcToLocal', FilterUtcDate)
    ...
    .constant('ngAppSettings', {
        ...
        , miIcons: [
            ...
            'fas fa-socks',
            'fas fa-solar-panel',
            'fa fa-grip-vertical text-black-50',
            'fa fa-grip-vertical text-black-50-alpha-down',
            'fa fa-grip-vertical text-black-50-alpha-up',
            'fa fa-grip-vertical text-black-50-amount-down',
            'fa fa-grip-vertical text-black-50-amount-up',
            'fa fa-grip-vertical text-black-50-down',
            'fa fa-grip-vertical text-black-50-numeric-down',
            'fa fa-grip-vertical text-black-50-numeric-up',
            'fa fa-grip-vertical text-black-50-up',
            'fas fa-soundcloud',
            'fas fa-spa',
