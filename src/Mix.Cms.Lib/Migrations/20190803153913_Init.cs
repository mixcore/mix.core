        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Priority = table.Column<int>(nullable: false),
                    Status = table.Column<int>(nullable: false),
                    AttributeName = table.Column<string>(maxLength: 50, nullable: false, defaultValueSql: "(N'')"),
                    BooleanValue = table.Column<bool>(nullable: true),
                    CreatedDateTime = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "('0001-01-01T00:00:00.0000000')"),
                    DataId = table.Column<string>(maxLength: 50, nullable: false, defaultValueSql: "(N'')"),
