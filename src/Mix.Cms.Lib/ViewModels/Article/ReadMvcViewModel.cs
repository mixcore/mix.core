...
namespace Mix.Cms.Lib.ViewModels.Article
{
        ...
        : ViewModelBase<MixCmsContext, MixArticle, ReadMvcViewModel>
    {
        ...
        public List<ViewModels.Module.ReadMvcViewModel> Modules { get; set; }
        ...
        public string TemplatePath
        {
            get
            {
                return CommonHelper.GetFullPath(new string[]
                {
                    ...
                    , MixService.GetConfig<string>(MixConstants.ConfigurationKeyword.Theme, Specificulture) ?? "Default"
                    , Template
                });
            }
        }
