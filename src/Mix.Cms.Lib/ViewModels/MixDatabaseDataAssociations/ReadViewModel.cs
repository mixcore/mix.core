...
namespace Mix.Cms.Lib.ViewModels.MixDatabaseDataAssociations
{
    public class ReadViewModel
        : ViewModelBase<MixCmsContext, MixDatabaseDataAssociation, ReadViewModel>
    {
        #region Properties
        ...
        public ReadViewModel(MixDatabaseDataAssociation model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
