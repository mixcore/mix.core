...
namespace Mix.Cms.Lib.ViewModels.Page
{
    public class ReadMvcViewModel: ViewModelBase<MixCmsContext, MixCategory, ReadMvcViewModel>
    {
        ...
        public List<PageModule.ReadMvcViewModel> Modules { get; set; } = new List<PageModule.ReadMvcViewModel>(); // Get All Module
        ...
        public string TemplatePath
        {
            get
            {
                return CommonHelper.GetFullPath(new string[]
                {
                    ...
                    , MixService.GetConfig<string>(MixConstants.ConfigurationKeyword.Theme, Specificulture)??  MixService.GetConfig<string>(MixConstants.ConfigurationKeyword.DefaultTemplateFolder)
                    , Template
                });
            }
        }
        ...
        {
            var getNavs = PageModule.ReadMvcViewModel.Repository.GetModelListBy(
        ...
        public Module.ReadMvcViewModel GetModule(string name)
        {
