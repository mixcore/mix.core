...
namespace Mix.Cms.Lib.ViewModels.Page
{
       ...
       : ViewModelBase<MixCmsContext, MixCategory, UpdateViewModel>
    {
        ...
        public List<PageModule.ReadMvcViewModel> ModuleNavs { get; set; } // Parent to Modules

        [JsonProperty("positionNavs")]
        public List<NavCategoryPositionViewModel> PositionNavs { get; set; } // Parent to Modules
        ...
        [JsonProperty("view")]
        public Template.UpdateViewModel View { get; set; }

        [JsonProperty("templates")]
        public List<Template.UpdateViewModel> Templates { get; set; }// Article Templates
        ...
        public override void ExpandView(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            this.Templates = this.Templates ?? ViewModels.Template.UpdateViewModel.Repository.GetModelListBy(
            ...
            if (this.View == null)
            {
                this.View = new ViewModels.Template.UpdateViewModel(new MixTemplate()
                {
        ...
        public List<NavCategoryPositionViewModel> GetPositionNavs(MixCmsContext context, IDbContextTransaction transaction)
        {
            var query = context.MixPosition
                  .Include(cp => cp.MixCategoryPosition)
                  //.Where(p => p.Specificulture == Specificulture)
                  .Select(p => new NavCategoryPositionViewModel()
                  {
                      CategoryId = Id,
                      PositionId = p.Id,
        ...
        public List<PageModule.ReadMvcViewModel> GetModuleNavs(MixCmsContext context, IDbContextTransaction transaction)
        {
            var query = context.MixModule
                .Include(cp => cp.MixCategoryModule)
                .Where(module => module.Specificulture == Specificulture)
                .Select(module => new PageModule.ReadMvcViewModel()
                {
                    CategoryId = Id,
                    ModuleId = module.Id,
                    Specificulture = Specificulture,
        ...
        public List<NavCategoryCategoryViewModel> GetParentNavs(MixCmsContext context, IDbContextTransaction transaction)
        {
        ...
        public List<NavCategoryCategoryViewModel> GetChildNavs(MixCmsContext context, IDbContextTransaction transaction)
        {
            var query = context.MixCategory
                .Include(cp => cp.MixCategoryCategoryMixCategory)
                .Where(Category => Category.Specificulture == Specificulture && Category.Id != Id)
