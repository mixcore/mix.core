...
namespace MixCore.Cms.Lib.ViewModels.Init
{
      ...
      : ViewModelBase<MixCmsContext, MixTheme, InitThemeViewModel>
    {
        ...
        public override async Task<RepositoryResponse<bool>> SaveSubModelsAsync(MixTheme parent, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            if (Asset != null && Asset.Length > 0 && Id == 0)
            {
                ...
                var layout = InitTemplateViewModel.Repository.GetSingleModel(
        ...
        public override async Task<RepositoryResponse<bool>> RemoveRelatedModelsAsync(InitThemeViewModel view, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            var result = await InitTemplateViewModel.Repository.RemoveListModelAsync(t => t.ThemeId == Id);
            if (result.IsSucceed)
            {
        ...
        public override RepositoryResponse<bool> RemoveRelatedModels(InitThemeViewModel view, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            var result = InitTemplateViewModel.Repository.RemoveListModel(t => t.ThemeId == Id);
            if (result.IsSucceed)
            {
                FileRepository.Instance.DeleteWebFolder(AssetFolder);
                FileRepository.Instance.DeleteFolder(TemplateFolder);
