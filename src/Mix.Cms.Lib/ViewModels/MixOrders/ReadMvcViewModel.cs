...
namespace Mix.Cms.Lib.ViewModels.MixOrders
{
    public class ApiOrderViewModel
        : ViewModelBase<MixCmsContext, MixOrder, ApiOrderViewModel>
    {
        #region Properties
        ...
        public ApiOrderViewModel(MixOrder model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        ...
        public override async Task<RepositoryResponse<bool>> RemoveRelatedModelsAsync(ApiOrderViewModel view, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
