...
namespace Mix.Cms.Lib.ViewModels.MixRelatedAttributeDatas
{
    public class ReadViewModel
        : ViewModelBase<MixCmsContext, MixDatabaseContentAssociation, ReadViewModel>
    {
        #region Properties
        ...
        public ReadViewModel(MixDatabaseContentAssociation model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
