...
namespace Mix.Cms.Lib.ViewModels.MixRelatedAttributeDatas
{
    public class NavigationViewModel
       : ViewModelBase<MixCmsContext, MixDatabaseContentAssociation, NavigationViewModel>
    {
        #region Model
        ...
        public NavigationViewModel(MixDatabaseContentAssociation model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
