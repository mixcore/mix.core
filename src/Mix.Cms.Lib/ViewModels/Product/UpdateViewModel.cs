...
namespace Mix.Cms.Lib.ViewModels.Product
{
        ...
        : ViewModelBase<MixCmsContext, MixProduct, UpdateViewModel>
    {
        ...
        [JsonProperty("view")]
        public ViewModels.Template.UpdateViewModel View { get; set; }

        [JsonProperty("templates")]
        public List<ViewModels.Template.UpdateViewModel> Templates { get; set; }// Product Templates
        ...
        public override void ExpandView(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            View = ViewModels.Template.UpdateViewModel.GetTemplateByPath(themeId, Template, TemplateFolderType, _context, _transaction);

            this.View = View ?? Templates.FirstOrDefault();

            if (this.View == null)
            {
                this.View = ViewModels.Template.UpdateViewModel.GetDefault(ActivedTheme, TemplateFolderType, "Products", Specificulture);
            }
        ...
        public List<NavRelatedProductViewModel> GetRelated(MixCmsContext context, IDbContextTransaction transaction)
        {
