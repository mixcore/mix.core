...
namespace Mix.Cms.Lib.ViewModels.MixAttributeSetDatas
{
    public class ODataWebViewModel
      : ODataViewModelBase<MixCmsContext, MixAttributeSetData, ODataWebViewModel>
    {
        #region Properties
        ...
        [JsonIgnore]
        public List<MixAttributeSetValues.ODataWebViewModel> Values { get; set; }

        public List<MixAttributeFields.ODataWebViewModel> Fields { get; set; }

        [JsonProperty("data")]
        public JObject Data { get; set; }

        [JsonProperty("relatedData")]
        public List<MixRelatedAttributeDatas.ODataWebViewModel> RelatedData { get; set; } = new List<MixRelatedAttributeDatas.ODataWebViewModel>();
        ...
        public ODataWebViewModel(MixAttributeSetData model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
        ...
        public override MixAttributeSetData ParseModel(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            Values = Values ?? MixAttributeSetValues.ODataWebViewModel
                .Repository.GetModelListBy(a => a.DataId == Id && a.Specificulture == Specificulture, _context, _transaction).Data.OrderBy(a => a.Priority).ToList();
            Fields = MixAttributeFields.ODataWebViewModel.Repository.GetModelListBy(f => f.AttributeSetId == AttributeSetId, _context, _transaction).Data;
            foreach (var field in Fields.OrderBy(f => f.Priority))
            {
        ...
        private JProperty ParseValue(MixAttributeSetValues.ODataWebViewModel item)
        {
        ...
        private void ParseModelValue(JToken property, MixAttributeSetValues.ODataWebViewModel item)
        {
            switch (item.DataType)
            {
                case MixEnums.MixDataType.DateTime:
