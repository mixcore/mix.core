...
namespace Mix.Cms.Lib.ViewModels.Shared.Info
{
    public class InfoProductViewModel
       : ViewModelBase<MixCmsContext, MixProduct, InfoProductViewModel>
    {
        #region Properties
        ...
        public InfoProductViewModel(MixProduct model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
            ...
            , MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            try
            {
                var query = context.MixCategoryProduct.Include(ac => ac.MixProduct)
                    .Where(ac =>
