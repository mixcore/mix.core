...
namespace Mix.Cms.Lib.ViewModels.Shared.Info
{
    public class InfoPageViewModel
       : ViewModelBase<MixCmsContext, MixCategory, InfoPageViewModel>
    {
        #region Properties
        ...
        [JsonProperty("childs")]
        public List<InfoPageViewModel> Childs { get; set; }
        ...
        public InfoPageViewModel(MixCategory model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
        ...
        public static async System.Threading.Tasks.Task<RepositoryResponse<List<InfoPageViewModel>>> UpdateInfosAsync(List<InfoPageViewModel> cates)
        {
            MixCmsContext context = new MixCmsContext();
            var transaction = context.Database.BeginTransaction();
            var result = new RepositoryResponse<List<InfoPageViewModel>>();
            try
            {
            ...
            {
                UnitOfWorkHelper<MixCmsContext>.HandleException<InfoPageViewModel>(ex, true, transaction);
                return new RepositoryResponse<List<InfoPageViewModel>>()
                {
                    IsSucceed = false,
                    Data = null,
                    Exception = ex
