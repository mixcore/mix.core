...
namespace Mix.Cms.Lib.ViewModels.Shared.Info
{
    public class InfoArticleViewModel
      : ViewModelBase<MixCmsContext, MixArticle, InfoArticleViewModel>
    {
        #region Properties
        ...
        public InfoArticleViewModel(MixArticle model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
