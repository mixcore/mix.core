...
namespace Mix.Cms.Lib.ViewModels.Shared.Info
{
    public class InfoThemeViewModel
      : ViewModelBase<MixCmsContext, MixTheme, InfoThemeViewModel>
    {
        #region Properties
        ...
        public InfoThemeViewModel(MixTheme model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
