...
namespace Mix.Cms.Lib.ViewModels.Shared
{
    public class MixTemplateViewModel
       : ViewModelBase<MixCmsContext, MixTemplate, MixTemplateViewModel>
    {
        #region Properties
        ...
        {
            RepositoryResponse<MixTemplateViewModel> result = new RepositoryResponse<MixTemplateViewModel>();
