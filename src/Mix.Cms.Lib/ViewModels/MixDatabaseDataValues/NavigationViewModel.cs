...
namespace Mix.Cms.Lib.ViewModels.MixDatabaseDataValues
{
      ...
      : ViewModelBase<MixCmsContext, MixDatabaseDataValue, NavigationViewModel>
    {
        ...
        public List<MixDatabaseDataAssociations.NavigationViewModel> DataNavs { get; set; }
        ...
        public override void ExpandView(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            {
                DataNavs = MixDatabaseDataAssociations.NavigationViewModel.Repository.GetModelListBy(d =>
            ...
            Field = MixDatabaseColumns.ReadViewModel.Repository.GetSingleModel(f => f.Id == MixDatabaseColumnId, _context, _transaction).Data;
        }
