...
namespace Mix.Cms.Lib.ViewModels.MixLanguages
{
    public class MobileViewModel
       : ViewModelBase<MixCmsContext, MixLanguage, MobileViewModel>
    {
        #region Properties
        ...
        public MobileViewModel(MixLanguage model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        ...
        public override RepositoryResponse<bool> RemoveRelatedModels(MobileViewModel view, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
        ...
        public override async Task<RepositoryResponse<bool>> RemoveRelatedModelsAsync(MobileViewModel view, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            foreach (var culture in Cultures.Where(c => c.Specificulture != Specificulture))
            {
                var lang = _context.MixLanguage.First(c => c.Keyword == Keyword && c.Specificulture == culture.Specificulture);
            ...
            , MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            try
            {
                ...
                {
                    var lang = new MobileViewModel(item, context, transaction);
            ...
            {
                var error = UnitOfWorkHelper<MixCmsContext>.HandleException<MobileViewModel>(ex, isRoot, transaction);
