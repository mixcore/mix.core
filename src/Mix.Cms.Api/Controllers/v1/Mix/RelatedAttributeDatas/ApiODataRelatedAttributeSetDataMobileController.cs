...
namespace Mix.Cms.Api.Controllers.v1.OData.RelatedAttributeSetDatas
{
        ...
        BaseApiODataController<MixCmsContext, MixRelatedAttributeData>
    {
        ...
        public async Task<ActionResult<MobileViewModel>> Details(string culture, string parentId, MixEnums.MixAttributeSetDataType, string id)
        {
                ...
                string parentId, string attributeSetName, ODataQueryOptions<MixRelatedAttributeData> queryOptions)
        {
            ...
            var result = await base.GetListAsync<MobileViewModel>(predicate, $"parent_{parentType}_{parentId}_{attributeSetName}", queryOptions);
            if (result != null)
            {
        ...
        [HttpPost, HttpOptions]
        [Route("{parentId}/{parentType}/{id}")]
        public async Task<ActionResult<MobileViewModel>> Save(string culture, string parentId, MixEnums.MixAttributeSetDataType, string id, [FromBody]JObject data)
        {
        ...
        [Route("{parentId}/{parentType}/{id}")]
        public async Task<ActionResult<DeleteViewModel>> Delete(string culture, string parentId, MixEnums.MixAttributeSetDataType, string id)
        {
