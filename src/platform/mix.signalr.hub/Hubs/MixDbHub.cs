...
namespace Mix.SignalR.Hubs
{
    ...
    public class MixDbHub : BaseSignalRHub
    {
        ...
        public MixDbHub(IAuditLogService auditLogService, IMixTenantService mixTenantService, IMemoryQueueService<MessageQueueModel> queueService, IMixMemoryCacheService memoryCache, MixCmsContext ctx) : base(auditLogService, mixTenantService)
        {
