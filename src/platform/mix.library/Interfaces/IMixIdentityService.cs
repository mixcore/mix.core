...
namespace Mix.Lib.Interfaces
{
    public interface IMixIdentityService
    {
        ...
        public Task<ApiResponseModel<TokenResponseModel>> ExternalLogin(RegisterExternalBindingModel model, CancellationToken cancellationToken = default);
        ...
        public Task<ApiResponseModel<TokenResponseModel>> GetTokenAsync(GetTokenModel model, CancellationToken cancellationToken = default);
        public Task<ApiResponseModel<TokenResponseModel>> LoginAsync(LoginRequestModel model, CancellationToken cancellationToken = default);
        public Task<ApiResponseModel<TokenResponseModel>> RenewTokenAsync(RenewTokenDto refreshTokenDto, CancellationToken cancellationToken = default);
