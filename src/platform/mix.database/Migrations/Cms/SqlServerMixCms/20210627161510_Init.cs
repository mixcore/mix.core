        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(4000)", nullable: false, collation: "Vietnamese_CI_AS"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemName = table.Column<string>(type: "nvarchar(250)", nullable: false, collation: "Vietnamese_CI_AS"),
                    Description = table.Column<string>(type: "nvarchar(4000)", nullable: false, collation: "Vietnamese_CI_AS"),
                    Content = table.Column<string>(type: "nvarchar(4000)", nullable: false, collation: "Vietnamese_CI_AS"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Configurations = table.Column<string>(type: "ntext", nullable: false, collation: "Vietnamese_CI_AS"),
