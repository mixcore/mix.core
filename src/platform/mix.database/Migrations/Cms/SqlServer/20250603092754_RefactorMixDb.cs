        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentDatabaseName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChildDatabaseName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GuidParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GuidChildId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
