        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentDatabaseName = table.Column<string>(type: "text", nullable: true),
                    ChildDatabaseName = table.Column<string>(type: "text", nullable: true),
                    GuidParentId = table.Column<Guid>(type: "uuid", nullable: true),
                    GuidChildId = table.Column<Guid>(type: "uuid", nullable: true),
