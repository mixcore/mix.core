        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(type: "varchar(400)", maxLength: 400, nullable: true, collation: "Vietnamese_CI_AS"),
                    Name = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: true, collation: "Vietnamese_CI_AS"),
                    NormalizedName = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: true, collation: "Vietnamese_CI_AS")
                },
                constraints: table =>
                {
