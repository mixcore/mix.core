        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    service_name = table.Column<string>(type: "nvarchar(250)", nullable: false, collation: "Vietnamese_CI_AS"),
                    section_name = table.Column<string>(type: "nvarchar(250)", nullable: true, collation: "Vietnamese_CI_AS"),
                    ...
                    is_encrypt = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData("mix_global_setting",
                columns: new[] { "id", "last_modified", "service_name", "section_name", "display_name", "description", "tenant_id", "system_name", "settings", "is_encrypt" },
                values: new object[] { 6, null, "portal", "GlobalSettings", "Global", "Global Settings", 1, "global", "{\"GlobalSettings\":{\"IsInit\":true,\"IsUpdateSystemDatabases\":false,\"EnableAuditLog\":true,\"IsLogStream\":false,\"AllowAnyOrigin\":false,\"IsHttps\":false,\"ResponseCache\":5,\"AesKey\":null,\"DefaultBaseUrl\":\"\",\"EnableOcelot\":false,\"InitStatus\":\"Blank\"}}", false });
            migrationBuilder.InsertData("mix_global_setting",
                columns: new[] { "id", "last_modified", "service_name", "section_name", "display_name", "description", "tenant_id", "system_name", "settings", "is_encrypt" },
            ...
            migrationBuilder.InsertData("mix_global_setting",
                columns: new[] { "id", "last_modified", "service_name", "section_name", "display_name", "description", "tenant_id", "system_name", "settings", "is_encrypt" },
                values: new object[] { 16, null, "portal", "Endpoints", "Endpoints", "Endpoints", 1, "endpoints", "{\"Endpoints\":{\"Account\":null,\"Common\":null,\"Portal\":null,\"Theme\":null,\"Mixcore\":null,\"Messenger\":null,\"Scheduler\":null,\"Grpc\":null,\"MixMq\":null,\"LocalGateway\":null,\"Storage\":null,\"UniversalPortal\":null}}", false });
            migrationBuilder.InsertData("mix_global_setting",
                columns: new[] { "id", "last_modified", "service_name", "section_name", "display_name", "description", "tenant_id", "system_name", "settings", "is_encrypt" },
            ...
            migrationBuilder.InsertData("mix_global_setting",
                columns: new[] { "id", "last_modified", "service_name", "section_name", "display_name", "description", "tenant_id", "system_name", "settings", "is_encrypt" },
                values: new object[] { 18, null, "portal", "MessageQueueSettings", "Queue", "Queue", 1, "queue", "{\"MessageQueueSettings\":{\"Provider\":\"MIX\",\"GoogleQueueSetting\":{\"CredentialFile\":\"\",\"ProjectId\":\"\"},\"AzureServiceBus\":{\"ConnectionStrings\":\"\",\"QueueName\":\"\"},\"Mix\":{\"ProjectId\":\"\"},\"RabitMqQueueSetting\":{\"HostName\":\"localhost\",\"UserName\":null,\"Password\":null,\"VHost\":null,\"Port\":5672},\"MQTT\":{\"HostName\":null,\"UserName\":null,\"Password\":null,\"Port\":1883,\"ClientId\":null,\"Topic\":null,\"UseTls\":false,\"UseWebSocket\":false}}}", false });
            migrationBuilder.InsertData("mix_global_setting",
                columns: new[] { "id", "last_modified", "service_name", "section_name", "display_name", "description", "tenant_id", "system_name", "settings", "is_encrypt" },
