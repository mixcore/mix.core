...
{
    public class MixDbTableConfiguration : TenantEntityBaseConfiguration<MixDbTable, int>

    {
        public MixDbTableConfiguration(DatabaseService databaseService) : base(databaseService)
        {
        }

        public override void Configure(EntityTypeBuilder<MixDbTable> builder)
        {
