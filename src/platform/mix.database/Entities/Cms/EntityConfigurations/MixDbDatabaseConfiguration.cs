...
{
    public class MixDbDatabaseConfiguration : TenantEntityUniqueNameBaseConfiguration<MixDbDatabase, int>

    {
        public MixDbDatabaseConfiguration(DatabaseService databaseService) : base(databaseService)
        {
        }

        public override void Configure(EntityTypeBuilder<MixDbDatabase> builder)
        {
