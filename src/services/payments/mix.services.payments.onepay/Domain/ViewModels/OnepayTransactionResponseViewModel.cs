...
namespace Mix.Services.Payments.Onepay.Domain.ViewModels
{
    public sealed class OnepayTransactionResponseViewModel
        : ViewModelBase<MixCmsContext, OnepayTransactionResponse, int, OnepayTransactionResponseViewModel>
    {
        #region Properties
        ...
        public OnepayTransactionResponseViewModel(MixCmsContext context) : base(context)
        {
        }
