...
namespace Mix.Services.Payments.Onepay.Domain.ViewModels
{
    public sealed class OnepayTransactionRequestViewModel
        : ViewModelBase<MixCmsContext, OnepayTransactionRequest, int, OnepayTransactionRequestViewModel>
    {
        #region Properties
        ...
        public OnepayTransactionRequestViewModel(MixCmsContext context) : base(context)
        {
        }
