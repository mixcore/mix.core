...
{
    public class MixPermissionViewModel : ViewModelBase<MixServiceDatabaseDbContext, MixPermission, int, MixPermissionViewModel>
    {
        #region Properties
        ...
        public MixPermissionViewModel(MixServiceDatabaseDbContext context) : base(context)
        {
        }
