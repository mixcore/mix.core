<<<<<<< develop
/* Sun Feb 14 2021 18:36:43 GMT+0700 (Indochina Time) */"use strict";
=======
/* Sun Feb 14 2021 17:26:37 GMT+0700 (Indochina Time) */"use strict";
...
"use strict";
app.factory("PostAttributeValueService", [
  "BaseService",
  function (baseService) {
    var serviceFactory = Object.create(baseService);
    serviceFactory.init("post-mix-database-data-value");
    // Define more service methods here
    return serviceFactory;
  },
]);
...
modules.component("mixDatabaseDataValues", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-database-data-values/mix-database-data-values.html?v=2",
  bindings: {
    header: "=",
    data: "=",
    canDrag: "=",
...
modules.component("postAttributeSetForm", {
  templateUrl:
    "/mix-app/views/app-portal/components/post-mix-database-form/view.html",
  bindings: {
    setId: "=",
    data: "=",
    attributes: "=",
