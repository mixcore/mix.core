/* Fri Jan 15 2021 08:35:06 GMT+0700 (Indochina Time) */"use strict";
...
app.factory("AppSettingsServices", [
  ...
  "$rootScope",
  "CommonService",
  function ($http, $rootScope, commonService) {
...
("use strict");
app.factory("AttributeSetService", [
  "BaseRestService",
  function (baseService) {
    var serviceFactory = Object.create(baseService);
...
("use strict");
app.factory("MixRestAttributeSetPortalService", [
  "BaseService",
  "CommonService",
  function (baseService, commonService) {
    var serviceFactory = Object.create(baseService);
...
app.factory("FileServices", [
  ...
  "CommonService",
  "BaseService",
  function ($http, $rootScope, commonService, baseService) {
    //var serviceBase = 'http://ngauthenticationapi.azurewebsites.net/';
    ...
    $scope.loadFeeds = function (url) {
      ...
      url =
        ...
        "/" +
          ...
          "&fields=type,name,story,full_picture,created_time,permalink_url,message,description,caption,attachments{media,type,target,subattachments},shares.summary(true).limit(0),likes.summary(true).limit(0),comments.summary(true).limit(0)&limit=10";
      $rootScope.isBusy = true;
      FB.api(url, function (response) {
        if (response.data) {
...
app.component("attributeSetEdm", {
  templateUrl:
    "/mix-app/views/app-portal/pages/attribute-set/components/edm/view.html",
  controller: [
    "$rootScope",
    function ($rootScope) {
      var ctrl = this;
...
modules.component('menuItemEditor', {
    ...
    controller: ['$rootScope', '$scope', 'ngAppSettings', '$location', 'RestRelatedAttributeSetPortalService', 'RestAttributeSetPortalService',
      ...
      ctrl.updateRefData = function (nav) {
        ...
        $location.url(
          `/portal/navigation/details?dataId=${nav.id}&attributeSetId=${nav.attributeSetId}&attributeSetName=${nav.attributeSetName}` +
...
modules.component("menuItemForm", {
  templateUrl:
    "/mix-app/views/app-portal/pages/navigation/components/menu-item-form/view.html",
  bindings: {
    attributeSetId: "=",
    attributeSetName: "=",
    attrDataId: "=?",
...
("use strict");
app.factory("PostAttributeDataService", [
  "BaseService",
  function (baseService) {
    var serviceFactory = Object.create(baseService);
...
app.component("postAttributeSet", {
  templateUrl:
    "/mix-app/views/app-portal/pages/post/components/attribute-set/view.html",
  bindings: {
    set: "=",
    parentType: "=?",
    parentId: "=?",
      ...
      ctrl.removeValueConfirmed = async function (nav) {
        ...
        if (result.isSucceed) {
          $rootScope.removeObjectByKey(
            ctrl.set.attributeSet.postData.items,
            "id",
            nav.id
          );
          $rootScope.isBusy = false;
...
app.component("themeExportAttributeSets", {
  templateUrl:
    "/mix-app/views/app-portal/pages/theme/components/theme-export-attribute-sets/view.html",
  controller: [
    "$rootScope",
    "$scope",
    "ngAppSettings",
    function ($rootScope, $scope) {
      ...
      ctrl.updateAttributeSetExport = function () {
        ctrl.selectedExport.attributeSets = angular.copy(
          $rootScope.filterArray(
            ctrl.exportData.attributeSets,
            ["isActived"],
            [true]
          )
        );
...
modules.component("addictionalField", {
  templateUrl:
    "/mix-app/views/app-portal/components/addictional-field/view.html",
  bindings: {
    model: "=",
    addictionalData: "=",
  },
...
modules.component("addictionalValue", {
  templateUrl:
    "/mix-app/views/app-portal/components/addictional-value/view.html",
  bindings: {
    addictionalData: "=?",
    addictionalDataId: "=?",
    parentType: "=?",
...
modules.component("attributeSetDataFilter", {
  templateUrl:
    "/mix-app/views/app-portal/components/attribute-set-data-filter/view.html",
  bindings: {
    query: "=",
    attributeSetName: "=?",
    attributeSetId: "=?",
...
modules.component("attributeSetNavValues", {
  templateUrl:
    "/mix-app/views/app-portal/components/attribute-set-nav-values/view.html",
  bindings: {
    attributeSetId: "=",
    attributeSetName: "=",
    parentId: "=",
