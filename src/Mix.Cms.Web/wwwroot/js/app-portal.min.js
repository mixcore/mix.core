/* Tue Dec 01 2020 12:54:30 GMT+0700 (Indochina Time) */"use strict";
...
app.controller("PostController", [
  ...
  function (
    ...
    $scope.saveSuccessCallback = async function () {
      if ($scope.activedData.addictionalData) {
        $scope.activedData.addictionalData.parentId = $scope.activedData.id;
        $scope.activedData.addictionalData.parentType = "Post";
        var saveData = await dataService.saveData(
          $scope.activedData.addictionalData
        );
      }
      $rootScope.isBusy = false;
      $scope.$apply();
