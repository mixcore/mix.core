/* Sun Apr 12 2020 15:35:40 GMT+0700 (Indochina Time) */'use strict';
...
modules.component('modalNavMetas', {
    ...
    controller: ['$rootScope', '$scope',  '$routeParams', 'ngAppSettings', 'RestAttributeSetDataPortalService', 'RestRelatedAttributeSetPortalService', 'RestAttributeFieldClientService',
        function ($rootScope, $scope, $routeParams, ngAppSettings, dataService, navService, fieldService) {
            ...
            ctrl.select = function (data) {
                ...
                if (data.isActived) {
                    ...
                    if (ctrl.parentId) {
                        navService.delete([data.id]).then(resp => {
                            if (resp.isSucceed) {
                                data.disabled = false;
            ...
            ctrl.createData = function () {
                ...
                if(!tmp){
                    ctrl.attrData.data.title= ctrl.newTitle;
                    ctrl.attrData.data.slug= $rootScope.generateKeyword(ctrl.newTitle, '-');
                    ctrl.attrData.data.type= ctrl.type;                   
                    dataService.save(ctrl.attrData).then(resp => {
                        if (resp.isSucceed) {
