...
'use strict';
app.controller('AttributeFieldController', 
    ['$scope', '$rootScope', '$routeParams', '$location', 'ngAppSettings', 'AttributeFieldService',
...
app.controller('AttributeSetController', 
    ['$scope', '$rootScope', '$routeParams', '$location', 'ngAppSettings'
    , 'AttributeSetService', 'AttributeFieldService',
    function ($scope, $rootScope, $routeParams, $location, ngAppSettings, service, fieldService) {
        BaseCtrl.call(this, $scope, $rootScope, $routeParams, ngAppSettings, service);
        $scope.types = [
            'Page',
            'Module',
        ...
        $scope.init = async function(){
            $scope.defaultField = await fieldService.getSingle();
        }
        $scope.addAttribute = function(){
            if($scope.activedData){
                var attr = angular.copy($scope.defaultField);
                $scope.activedData.attributes.push(attr);
            }
        }
    }]);
