/* Fri Jan 15 2021 08:32:39 GMT+0700 (Indochina Time) */"use strict";
  ...
  function (
    ...
    $scope.saveSuccessCallback = function () {
      if ($location.path() == "/portal/attribute-set-data/create") {
        $rootScope.goToSiteUrl(`/portal/attribute-set-data/details?dataId=${$scope.viewModel.id}`);
      }
    };
    ...
    $scope.edit = function (data) {
      $rootScope.goToSiteUrl("/portal/attribute-set-data/details?dataId=" + data.id);
    };
