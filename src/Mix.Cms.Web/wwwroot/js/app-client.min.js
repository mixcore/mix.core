        ...
        ['$rootScope', '$scope', 'GlobalSettingsService', 'CommonService', 'AuthService', 'localStorageService', 'TranslatorService', 'SharedModuleDataService',
            ...
            function ($rootScope, $scope, globalSettingsService, commonService, authService,
                ...
                $scope.init = function (lang) {
                    ...
                    $scope.userData = localStorageService.get('honda_user');
                    $rootScope.isLogin =  $scope.userData !== null;
                    if (!$rootScope.isBusy) {
...
modules.component('attributeSetForm', {
    ...
    controller: ['$rootScope', '$scope', '$routeParams', 'RestAttributeSetDataClientService', 
...
modules.component('hondaUserProfile', {
    binding: {
        user: '='
    },
    templateUrl: '/app/app-shared/customs/honda-user/honda-user-profile.html',
    controller: ['$scope', '$rootScope', 'localStorageService', 'HondaUserService',
        function ($scope, $rootScope, localStorageService, service) {
            ...
            ctrl.$onInit = async function () {
                ctrl.userData = localStorageService.get('honda_user');
            };
            ctrl.isBusy = false;
...
modules.component('uploadImage', {
    templateUrl: '/app/app-client/components/customs/upload-image/upload-image.html?v=2',
    bindings: {
        header: '=?',
        description: '=?',
        src: '=',
    ...
    controller: ['$rootScope', '$scope', 'ngAppSettings', 'MediaService', function ($rootScope, $scope, ngAppSettings, mediaService) {
        ...
        var image_placeholder = 'http://demo.mixcore.org/content/templates/honda-piccolo/uploads/2020-05/screenshot17e7b2a3707d440e4bc7d9e78211840ec.png';
        ctrl.isImage = false;
        ctrl.mediaNavs = [];
