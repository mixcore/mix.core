...
namespace Mix.Cms.Api.OData.ViewModels.MixAttributeSetDatas
{
      ...
      : ODataViewModelBase<MixCmsContext, MixAttributeSetData, ODataReadViewModel>
    {
        ...
        [JsonProperty("values")]
        public List<Lib.ViewModels.MixAttributeSetValues.ReadViewModel> Values { get; set; }

        [JsonProperty("fields")]
        public List<Lib.ViewModels.MixAttributeFields.ReadViewModel> Fields { get; set; }
        ...
        {
            Values = Lib.ViewModels.MixAttributeSetValues.ReadViewModel
                .Repository.GetModelListBy(a => a.DataId == Id && a.Specificulture == Specificulture, _context, _transaction).Data.OrderBy(a => a.Priority).ToList();
            Fields = Lib.ViewModels.MixAttributeFields.ReadViewModel.Repository.GetModelListBy(f => f.AttributeSetId == AttributeSetId, _context, _transaction).Data;
            Values.ForEach(val =>
            {
