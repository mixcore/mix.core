...
namespace Mix.Cms.Api.OData.ViewModels.MixRelatedAttributeDatas
{
       ...
       : ODataViewModelBase<MixCmsContext, MixRelatedAttributeData, ODataUpdateViewModel>
    {
        ...
        [JsonProperty("data")]
        public Lib.ViewModels.MixAttributeSetDatas.UpdateViewModel Data { get; set; }
        ...
        {
            var getData = Lib.ViewModels.MixAttributeSetDatas.UpdateViewModel.Repository.GetSingleModel(p => p.Id == Id && p.Specificulture == Specificulture
