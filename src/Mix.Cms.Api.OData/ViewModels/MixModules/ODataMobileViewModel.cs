...
namespace Mix.Cms.Api.OData.ViewModels.MixModules
{
    public class ODataMobileViewModel : ViewModelBase<MixCmsContext, MixModule, ODataMobileViewModel>
    {
            ...
            try
            {
                ...
                if (getModule.IsSucceed)
                {
                    ...
                    if (getAttrSet.IsSucceed)
                    {
                        ...
                        MixAttributeSetDatas.ODataMobileViewModel data = new MixAttributeSetDatas.ODataMobileViewModel()
                        {
                            Id = dataId,
                            CreatedBy = createdBy,
                        ...
                        var getNavigation = await MixRelatedAttributeDatas.ODataDeleteViewModel.Repository.GetSingleModelAsync(
                        ...
                        {
                            data.RelatedData.Add(new MixRelatedAttributeDatas.ODataMobileViewModel()
                            {
        ...
        private static Task SendEdm(string culture, string template, JObject data)
        {
            return Task.Run(() =>
            {
                ...
                {
                    var getEdm = Lib.ViewModels.MixTemplates.UpdateViewModel.GetTemplateByPath(template, culture);
