...
namespace Mix.Cms.Api.OData.ViewModels.MixAttributeSetValues
{
    public class ODataMobileViewModel
      : ODataViewModelBase<MixCmsContext, MixAttributeSetValue, ODataMobileViewModel>
    {
        #region Properties
        ...
        public ODataMobileViewModel(MixAttributeSetValue model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
            IsCache = false;
        }
        ...
        public override void ExpandView(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            {
                DataNavs = MixRelatedAttributeDatas.ODataMobileViewModel.Repository.GetModelListBy(d =>
